package ba.unsa.etf.rpr.dtotest;
...
class AccountTest {
    ...
    void usernameValidationOK() {
        ...
        assertThrows (AccountValidationFailedException.class, () -> account.setUserName ("user"),
    ...
    void emailValidationOK() {
        ...
        assertThrows (AccountValidationFailedException.class, () -> account.setEmailAdress ("email"),
                MyResourceBundle.getString ("InvalidEmailAddress"));
        assertThrows (AccountValidationFailedException.class, () -> account.setEmailAdress ("email@"),
                MyResourceBundle.getString ("InvalidEmailAddress"));
        assertThrows (AccountValidationFailedException.class, () -> account.setEmailAdress ("email@adress."),
                MyResourceBundle.getString ("InvalidEmailAddress"));
        assertThrows (AccountValidationFailedException.class, () -> account.setEmailAdress ("emailadress.com"),
                MyResourceBundle.getString ("InvalidEmailAddress"));
    ...
    void passwordValidationOK() {
        ...
        assertThrows (AccountValidationFailedException.class, () -> account.setPassword ("short"),
                MyResourceBundle.getString ("PasswordLengthError"));
        assertThrows (AccountValidationFailedException.class, () -> account.setPassword (":thispasswordwillbetoolong:"),
                MyResourceBundle.getString ("PasswordLengthError"));

        // have at least one uppercase letter
        assertThrows (AccountValidationFailedException.class, () -> account.setPassword ("doesnthaveuppercase"),
                MyResourceBundle.getString ("PasswordUppercaseError"));

        // have at least one lowercase letter
        assertThrows (AccountValidationFailedException.class, () -> account.setPassword ("DOESNTHAVELOWERCASE"),
                MyResourceBundle.getString ("PasswordLowercaseError"));

        // have at least one number
        assertThrows (AccountValidationFailedException.class, () -> account.setPassword ("DOESNTHAVEnumber"),
                MyResourceBundle.getString ("PasswordNumberError"));

        // have at least one special characther @#$%
        assertThrows (AccountValidationFailedException.class, () -> account.setPassword ("SpecialCharacter22"),
